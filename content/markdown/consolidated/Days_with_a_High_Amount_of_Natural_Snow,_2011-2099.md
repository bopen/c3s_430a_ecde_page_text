...
# Projected change in the period with a high amount of natural snow
...
| :--- | :--- | :--- | :--- | :--- |
|The projected change in the number of days with a high amount of natural snow (Aug-Jul) in `<NUTS>` under `<scenario>` at `<elevation>`.|Showing the ensemble mean and range for eight GCM-RCM pairings. Hover over the time series to display the values and the action buttons.|Year|Days|"max", "mean", "min"|
...
|Title|SubTitle|HorizontalAxis|VerticalAxis|Labels|
| :--- | :--- | :--- | :--- | :--- |
|Historical (Aug-Jul) days with high natural snow amount from the UERRA reanalysis.||Year|Days|, , |
